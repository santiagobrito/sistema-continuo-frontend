                ...
                return (
                  ...
                  >
                    <td className="px-4 py-2.5 text-sm text-gray-700">
                      ...
                      {tier.min_qty}+ {product.unidad_venta ? `${product.unidad_venta}s` : "unidades"}
                    </td>
                    ...
                    <td className="px-4 py-2.5 text-sm text-right text-gray-500">
                      {formatPrice(discountedPrice)} c/{product.unidad_venta || "u"}
                    </td>
                  </tr>
                );
              })}
          ...
          >
            {loading ? (
              ...
              <span className="flex items-center justify-center gap-2">
                ...
                {quantity > 1 ? `Agregar ${quantity} ${product.unidad_venta ? `${product.unidad_venta}s` : "un."} — ${formatPrice(totalPrice)}` : "Agregar al carrito"}
              </span>
            )}
          </button>
        </div>
