...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-1 ml-auto">
          <button
            ...
            className="md:hidden p-2 rounded-full hover:bg-gray-100 text-gray-600 transition-colors cursor-pointer"
            aria-label="Buscar"
          >
      ...
      {/* Mobile search panel — separado del menú principal */}
      {mobileSearchOpen && (
        <div className="md:hidden border-t bg-white p-3 shadow-sm">
          <SearchBar mobile />
        </div>
      )}
