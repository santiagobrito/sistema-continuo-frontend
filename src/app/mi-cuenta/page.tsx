...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  "sent-to-tactica": { label: "Pasado a Táctica", color: "bg-indigo-100 text-indigo-700" },
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <Link href="/mi-cuenta/perfil" className="bg-white rounded-xl border border-gray-100 hover:border-[#013d5a]/20 p-5 transition-all cursor-pointer">
            ...
            <p className="text-xs text-gray-500 mt-1">Datos, facturación, direcciones</p>
          </Link>
        ...
        <div className="bg-white rounded-xl border border-gray-100">
          ...
          {loadingOrders ? (
            ...
            <div className="p-8 text-center">
              <p className="text-gray-500 text-sm">Aún no tenés pedidos.</p>
