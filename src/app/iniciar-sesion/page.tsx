...
// useSearchParams() fuerza CSR bailout — Next.js requiere wrap en Suspense para
// que el resto de la página pueda prerenderizarse sin trabar el build.
export default function LoginPage() {
  return (
    <main className="bg-gray-50 min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <Suspense fallback={<div className="bg-white rounded-2xl border border-gray-100 p-8 text-center text-sm text-gray-400">Cargando…</div>}>
          <LoginForm />
        </Suspense>
