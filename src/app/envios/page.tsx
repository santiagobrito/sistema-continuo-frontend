      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          {[
            ...
            { title: "Moto CABA (Zona 1)", price: "$7.139", time: "Despacho en 24-48hs hábiles", desc: "Envío en moto a domicilio dentro de CABA. Precio por bulto — según el pedido puede ajustarse.", zones: "CABA" },
            { title: "Moto GBA Zona 2", price: "$7.139", time: "Despacho en 24-48hs hábiles", desc: "Vicente López, San Martín, Tres de Febrero, Matanza Norte, Lomas de Zamora, Lanús, Avellaneda. Precio por bulto — según el pedido puede ajustarse.", zones: "GBA cercano" },
            { title: "Moto GBA Zona 3", price: "$9.559", time: "Despacho en 24-48hs hábiles", desc: "Tigre, San Isidro, San Fernando, Malvinas Argentinas, San Miguel, José C. Paz, Moreno, Morón, Ituzaingó, Hurlingham, Merlo, Matanza Sur, Ezeiza, Esteban Echeverría, Almirante Brown, Quilmes, Florencio Varela, Berazategui. Precio por bulto — según el pedido puede ajustarse.", zones: "GBA medio" },
            { title: "Moto GBA Zona 4", price: "$10.989", time: "Despacho en 24-48hs hábiles", desc: "Zárate, Campana, Escobar, Pilar, Luján, General Rodríguez, Marcos Paz, Cañuelas, San Vicente, Presidente Perón, La Plata, Ensenada, Berisso. Precio por bulto — según el pedido puede ajustarse.", zones: "GBA ampliado" },
