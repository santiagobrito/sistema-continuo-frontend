      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          {[
            ...
            { title: "Correo Argentino a sucursal", price: "Calculado en checkout", time: "Entrega 3-7 días hábiles", desc: "Retiro en sucursal de Correo Argentino más cercana. Más económico que a domicilio.", zones: "Todo el país" },
