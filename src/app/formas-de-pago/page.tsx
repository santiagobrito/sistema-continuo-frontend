        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-gray-900">Pago y retiro en local</h2>
            </div>
            <p className="text-sm text-gray-600 mb-2">Pagás en efectivo y te llevás el pedido en el momento. Solo retiro en local — no se despacha a domicilio con esta opción.</p>
